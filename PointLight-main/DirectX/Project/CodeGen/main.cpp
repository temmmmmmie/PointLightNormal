...
int main()
{
	...
	wstring strCppPath = strProjPath + L"\\Source\\ScriptMgr.cpp";
	wstring strHeaderPath = strProjPath + L"\\Source\\ScriptMgr.h";

	// 1. 현재 존재하는 모든 스크립트를 알아내야함.
	wstring strScriptIncludePath = CPathMgr::GetIncludePath();
	wstring strScriptCode = strScriptIncludePath + L"Source\\Scripts\\";
